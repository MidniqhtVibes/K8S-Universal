...
def valid_config() -> ClusterConfig:
    return ClusterConfig.model_validate({
        ...
        "name": "test-cluster",
        "proxmox": {"endpoint": "https://pve.test:8006/", "node": "pve", "datastore": "local-lvm", "template_vm_id": 9876, "bridge": "vmbr0", "verify_tls": False, "vm_name_include_cluster": True, "credential_ref": "credential://proxmox"},
        ...
        "kubernetes": {"version": "v1.36", "api_port": 6443, "pod_cidr": "192.168.0.0/16", "service_cidr": "10.96.0.0/12"},
        "nodes": [
